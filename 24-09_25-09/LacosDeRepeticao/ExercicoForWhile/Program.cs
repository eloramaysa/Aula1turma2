...
namespace ExercicoForWhile
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var wordCont = FindByFor(Console.ReadLine());

            Console.WriteLine($"Encontrados: {wordCont}");
            Console.ReadKey();
        }
        /// <summary>
        ...
        /// <returns>Retorna a quantidade encontrada na expressão</returns>
        private static int FindByFor(string wordFind)
        {
            ...
            for (int i = 0; i < lengthText; i++)
            {
                ...
                if (compareWord == wordFind) contWordFind++;

            }
            return contWordFind;
        }

        //Atalho para usar o summary: /// 
        /// <summary>
