...
using WebCoreUsuarios.Models;

namespace WebCoreUsuarios.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class UsuariosController : ControllerBase
    {
        private readonly UsuarioBdCoreWebContext _context;

        public UsuariosController(UsuarioBdCoreWebContext context)
        {
            _context = context;
        }
