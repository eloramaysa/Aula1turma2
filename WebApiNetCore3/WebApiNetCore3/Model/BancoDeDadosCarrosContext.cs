...
{
    public partial class BancoDeDadosCarrosContext : DbContext
    {
        public BancoDeDadosCarrosContext()
        {
        }

        public BancoDeDadosCarrosContext(DbContextOptions<BancoDeDadosCarrosContext> options)
            : base(options)
        {
        }
