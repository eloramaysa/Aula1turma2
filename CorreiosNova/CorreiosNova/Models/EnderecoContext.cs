namespace CorreiosNova.Models
{
    ...
    public class EnderecoContext : DbContext
    {
        ...
        // 'CorreiosNova.Models.EnderecoContext' database on your LocalDb instance. 
        // 
        ...
        public System.Data.Entity.DbSet<CorreiosNova.Models.Endereco> Enderecoes { get; set; }
